...
import {
    ...
    return (
        ...
        <div className="absolute w-[600px] h-[600px] bg-emerald-400/10 blur-[120px] rounded-full -top-48 -left-48 animate-pulse" />
        <div className="absolute w-[500px] h-[500px] bg-teal-300/10 blur-[100px] rounded-full -bottom-32 -right-32 animate-pulse delay-700" />
        ...
        <div className="relative max-w-xl w-full text-center">
            ...
            <h2 className="text-6xl font-black leading-tight tracking-tighter">
                Welcome Back to <br /> <span className="text-emerald-400">SwiftShop</span>
            </h2>
            </div>
            ...
            >
            Experience the future of premium shopping with lightning fast delivery and secure, transparent checkout.
            </p>
            ...
            <div className="mt-16 grid grid-cols-3 gap-8 text-sm text-center">
                <div className="space-y-3 group cursor-default">
                    ...
                    <p className="font-bold tracking-wide text-emerald-100/80 uppercase text-[10px]">Free Delivery</p>
                </div>
                ...
                <div className="space-y-3 group cursor-default">
                    ...
                    <p className="font-bold tracking-wide text-emerald-100/80 uppercase text-[10px]">Secure Pay</p>
                </div>

                <div className="space-y-3 group cursor-default">
                    <div className="size-12 rounded-2xl bg-white/5 border border-white/10 flex items-center justify-center mx-auto group-hover:bg-emerald-500/20 group-hover:border-emerald-500/50 transition-all duration-500">
                        <FontAwesomeIcon icon={faClock} className="w-5 h-5 text-emerald-400" />
                    </div>
                    <p className="font-bold tracking-wide text-emerald-100/80 uppercase text-[10px]">24/7 Support</p>
                </div>
            </div>
